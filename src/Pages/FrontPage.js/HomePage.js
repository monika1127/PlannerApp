        ...
        <div className="home-page__container">
          <div className="home-page__about-app">
            ...
            <div className="about__text">
              ...
              lacinia molestie ex aliquet egestas. Aliquam arcu ex, hendrerit
              eget orci lacinia, dapibus ornare leo. Cras vitae mollis mauris.{' '}
            </div>
            <Link
              to="/about"
              className="about__link button button--small button--secondary-neutral"
            >
              How it works?
            </Link>
          </div>
          <div className="home-page__signIn">
            <div className="signIn__slogan">
              <div className="signIn__slogan--additionall">
